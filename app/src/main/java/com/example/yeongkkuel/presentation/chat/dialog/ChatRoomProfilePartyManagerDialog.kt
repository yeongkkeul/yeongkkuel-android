...
import com.example.yeongkkuel.databinding.DialogChatRoomProfilePartyManagerBinding

class ChatRoomProfilePartyManagerDialog(
    context: Context,
    private val onCancelClick: () -> Unit,
    private val onExpelClick: () -> Unit
) : Dialog(context, R.style.CustomDialogDimmed) {

    private lateinit var binding: DialogChatRoomProfilePartyManagerBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogChatRoomProfilePartyManagerBinding.inflate(LayoutInflater.from(context))
    ...
    private fun setupListeners() {
        ...
        binding.btnExpel.setOnClickListener {
            dismiss()
            onExpelClick()
        }
    }
