...
class Term4Fragment : Fragment() {

    private var _binding: FragmentTerm4Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTerm4Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 초기 체크 상태 UI 반영
        val isChecked = viewModel.isCheckedThirdParty.value ?: false
        binding.ivCheckThirdParty.isSelected = isChecked
        ...
        binding.ivCheckThirdParty.setOnClickListener {
            val wasChecked = viewModel.isCheckedThirdParty.value == true
            val newChecked = !wasChecked

            // 뷰모델에도 상태 반영
            viewModel.isCheckedThirdParty.value = newChecked
            // 현재 프래그먼트의 UI도 업데이트
            binding.ivCheckThirdParty.isSelected = newChecked
